...
$SRC_DIR/../common/secret_decoder.py -r $SRC_DIR/files ./files -e '.*skip$' '__pycache__'
...
# DDNS.
rsync -aP --exclude='__pycache__' $SRC_DIR/../common $CUSTOM_FILES_DIR/root/
rsync -aP --exclude='__pycache__' $SRC_DIR/../util-cookbook/tencent-cloud $CUSTOM_FILES_DIR/root/util-cookbook/
